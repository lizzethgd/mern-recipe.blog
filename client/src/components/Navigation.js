...
const Navigation = () => {
  ...
  const userLog = (
  <>
    <button className="w3-button w3-padding-large" > <img src={ !user ? avatar : user.profilePic } className="w3-circle" style={{border: "2px solid #fff", height:"30px", width:"30px"}} alt="Avatar" /></button>     
