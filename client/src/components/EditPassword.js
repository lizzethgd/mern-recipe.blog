...
const handleSubmit = (e) =>{
  ...
  try{
    ...
    UserService.updateProfile( updateUserPassword).then(data=> {
    setUser(data.user);
    history('/myprofile')
      })
      ...
      <div className="w3-row padd  "  >    
        ...
        <div className="w3-margin" style={{display: "flex"}}>
          ...
          <div className="w3-border" style={{display: "flex"}} >
            <input className="w3-input" type={passwordsShow.currentPwShow.typePass} id="currentPassword" onChange={e => handleChange(e)} onKeyDown={handleEnter} placeholder='Current password'/>
        ...
        <div className="w3-margin"  style={{display: "flex"}}>
          ...
          <div className="w3-border " style={{display: "flex"}}>
            <input className="w3-input" type={passwordsShow.newPwShow.typePass} id="newPassword" onChange={e => handleChange(e)} onKeyDown={handleEnter} placeholder='New password'/>
        ...
        <div className="w3-margin"  style={{display: "flex"}}>
          <i className="fa-solid fa-lock fa-fw w3-margin-top w3-margin-right w3-text-theme" title='New password'/>
          <div className="w3-border" style={{display: "flex"}}>
            <input className="w3-input" type={passwordsShow.confirmPwShow.typePass} id="password" onChange={e => handleChange(e)} onKeyDown={handleEnter} placeholder='Confirm new password'/>
